...
# --- 3. BỘ NÃO AI: THERMAL CORE (LÕI 1,2,3) ---
...
def process_matrix_v13_56():
    ...
    for num, s in stats.items():
        ...
        res.append({"Số": num, "Điểm": score, "An": s["max_an"], "Tang": calculate_tier(s["all_losses"], 71), "DâySạch": s["clean_wire_count"], "Cứng(10k)": hard})
